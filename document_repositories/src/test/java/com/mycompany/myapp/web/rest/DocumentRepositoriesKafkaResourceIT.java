...
class DocumentRepositoriesKafkaResourceIT {
    ...
    void setup() {
        ...
        DocumentRepositoriesKafkaResource kafkaResource = new DocumentRepositoriesKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/document-repositories-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/document-repositories-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
