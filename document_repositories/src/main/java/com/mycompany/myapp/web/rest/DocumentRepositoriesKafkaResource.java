...
@RestController
@RequestMapping("/api/document-repositories-kafka")
public class DocumentRepositoriesKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DocumentRepositoriesKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DocumentRepositoriesKafkaResource(KafkaProperties kafkaProperties) {
